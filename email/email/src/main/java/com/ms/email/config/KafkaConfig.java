...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EmailDTO> consumerFactory(){
        ...
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.ms.email.custom.CustomEmail");

        return new DefaultKafkaConsumerFactory<>(config);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EmailDTO> emailListener(){
